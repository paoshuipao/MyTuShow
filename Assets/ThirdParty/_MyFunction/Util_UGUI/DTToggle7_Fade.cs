...
[AddComponentMenu("我的组件/DOTween/DTToggle7_Fade")]
public class DTToggle7_Fade : MonoBehaviour 
{
    ...
    private CanvasGroup mOneGroup, mTwoGroup, mThreeGroup, mFourGroup, mFiveGroup, mSixGroup, mSevenGroup;
    ...
    void Awake()
    {
        ...
        {
            MyLog.Red("这七个游戏对象有空的情况   " + gameObject);
            return;
        }
