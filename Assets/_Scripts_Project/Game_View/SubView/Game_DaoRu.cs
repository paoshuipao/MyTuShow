...
public class Game_DaoRu : SubUI
{
    ...
    protected override void OnStart(Transform root)
    {
        ...
        MyEventCenter.AddListener<List<ResultBean>,int>(E_GameEvent.OnClickDuoTuDaoRu, E_OnDuoTuDaoRu);
    ...
    private void E_OnDuoTuDaoRu(List<ResultBean> resultBeans,int index)       // 点击了导入
    {
